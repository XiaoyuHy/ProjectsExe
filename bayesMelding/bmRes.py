...
def plot(useSimData):
	...
	# plt.plot(numMo, avg_rmse_bm_outSample, 'g-', label= 'BM mean')
	...
	plt.savefig('RMSE_outSample.png')
	plt.show()
	plt.close()

	plt.figure()
	plt.plot(numMo, median_var, 'c-', label= 'BM median')
	# plt.plot(numMo, avg_avgVar_bm_outSample, 'g-', label= 'BM 0.5 quantile')
	...
	plt.legend(loc='upper left')
	plt.title('Out of sample prediction')
	plt.savefig('avgVar_outSample.png')
	plt.show()
	plt.close()

	plt.figure()
	plt.plot(numMo, median_cov, 'c-', label= 'BM median')
	# plt.plot(numMo, avg_predicAccuracy_bm_outSample, 'g-', label= 'BM mean')
	...
	# plt.axhline(avg_predicAccuracy_krig_outSample, color = 'g', linestyle = '--', label='Kriging mean')
	...
	plt.legend(loc='lower left')
	plt.title('Out of sample prediction')
	plt.savefig('predicAccuracy_outSample.png')
	plt.show()
	plt.close()   
