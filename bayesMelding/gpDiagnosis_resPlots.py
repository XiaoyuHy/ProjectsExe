...
def plot_qq_parUncerty(parUncertyOverSeeds = False, numMo = 500, SEED=None, indivError = False, index_Xaxis =True):
	...
	plt.scatter(std_norm_quantile, np.sort(std_yEst_Zs), marker = '.', color ='k')
	plt.scatter(std_norm_quantile, Uqunatile, color = 'k', marker = '_') 
	plt.scatter(std_norm_quantile, Lqunatile, color = 'k', marker = '_') 
	plt.plot(std_norm_quantile, std_norm_quantile, color='k')
	...
	plt.figure()
	plt.scatter(std_norm_quantile, np.sort(std_yEst_yHat),  marker = '.', color ='k')
	plt.scatter(std_norm_quantile, Uqunatile, color = 'k', marker = '_') 
	plt.scatter(std_norm_quantile, Lqunatile, color = 'k', marker = '_') 
	plt.plot(std_norm_quantile, std_norm_quantile, color='k')
	plt.xlabel('Theoretical Quantiles')
	...
	plt.figure()
	# sm.qqplot(standardised_y_estimate, line='45')
	plt.scatter(std_norm_quantile, np.sort(std_yEst_yTilde),  marker = '.', color ='k')
	plt.scatter(std_norm_quantile, Uqunatile, color = 'k', marker = '_') 
	plt.scatter(std_norm_quantile, Lqunatile, color = 'k', marker = '_')  
	plt.plot(std_norm_quantile, std_norm_quantile, color='k')
	plt.xlabel('Theoretical Quantiles')
