...
def predic_gpRegression(theta_idx, theta, X_train, y_train, X_test, y_test, X_tildZs, y_tildZs, crossValFlag = False,  SEED=None, numMo = None, useSimData =False, grid= False, \
  ...
  # The following code is for Zhat | Zhat, Ztilde
    ...
    if not crossValFlag:
        ...
        if marginZhat:
            ...
            std_yEst_yHat = standardised_y_estimate
    ...
    if marginZtilde:
        ...
        std_yEst_yTilde = standardised_y_estimate
    ...
    return [samples_Zs, samples_yHat, samples_yTilde]
